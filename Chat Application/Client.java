...
public class Client implements ActionListener
{
    ...
    Client()
    {
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icons/ClientLogo.png"));
        ...
        mainframe.setSize(450, 700);    //Frame
        mainframe.setLocation(800, 50 );
    ...
    {
        Client cobj = new Client();   //class object 
       // Server s = new Server(); 
         try
        {
